...
parser.add_argument(
    "--data", type=str, required=False, default="BatteryLifeLLM", help="dataset type"
)
parser.add_argument(
    "--root_path",
    type=str,
...
# finetune
parser.add_argument(
    "--finetune_dataset", type=str, help="the target dataset for model finetuning"
)
...
for ii in range(args.itr):
    ...
    path = os.path.join(
        args.save_path, setting + "-" + args.model_comment
